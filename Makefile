...
$(FORTRAN_EXEC): simple_xy_zarr_rd.f90
	$(FC) $< -o $@  -I${NCDIR}/include -L${NCDIR}/lib64 -lnetcdff -lnetcdf -I${HDF5DIR}/include -lhdf5_hl -lhdf5 -L${HDF5DIR}/lib

$(C_EXEC): simple_xy_zarr_rd.c
	$(CC) $< -o $@ -I${NCDIR}/include -L${NCDIR}/lib64 -lnetcdf -I${HDF5DIR}/include -L${HDF5DIR}/lib -lhdf5_hl -lhdf5 
